...
public class ImageActivity2 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if(extras != null){
            String detail = extras.getString("Key");
            if(detail != null){
                Toast.makeText(this, detail, Toast.LENGTH_SHORT).show();
            }
        }

        imageSpinner = findViewById(R.id.ratingSpinner2);
        ratingButton = findViewById(R.id.ratingButton2);
        callSomeone = findViewById(R.id.callSomeone2);
        ...
        ratingButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                rIntent.putExtra("Key2", getSelection);
